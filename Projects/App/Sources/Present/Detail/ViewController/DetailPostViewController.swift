...
final class DetailPostViewController: BaseVC<DetailPostViewModel>, CommentDataProtocol {
    ...
    private let firstVoteButton = UIButton().then {
        ...
        $0.backgroundColor = SharedAsset.Colors.grayDark.color
    }
    ...
    private func votePostLayout(voting: Int) {
        ...
        case 1:
            ...
            secondVoteButton.backgroundColor = SharedAsset.Colors.grayDark.color
        case 2:
            firstVoteButton.backgroundColor = SharedAsset.Colors.grayDark.color
...
extension DetailPostViewController {
    private func setDefaultSubmitButton() {
        ...
        submitCommentButton.setTitleColor(SharedAsset.Colors.grayDark.color, for: .normal)
    }
}
